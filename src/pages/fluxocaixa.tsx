...
interface Lancamento {
  id: string;
  data: string; // yyyy-mm-dd — data de pagamento estimada/prevista (mesma da página Recebíveis)
  tipo: "entrada" | "saida";
  origem: string;
  descricao: string;
  categoria: string;
...
function deslocarReferencia(
  ...
  if (granularidade === "semana") d.setDate(d.getDate() + passo * 7);
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-text-muted">
          Entradas e saídas realizadas e previstas, lançamento a lançamento —
          filtre por semana, mês ou ano. Itens ainda não recebidos/pagos
          aparecem na data de pagamento estimada, marcados como "Previsto".
        </p>
      </div>
